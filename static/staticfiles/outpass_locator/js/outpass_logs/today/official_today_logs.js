...
var staff_official_outpass_logs_today_table = $('#staff_official_outpass_today_logs');


staff_official_outpass_logs_today_table.DataTable( {
    responsive: true,
    
    ajax: {
        url: $('#staff_official_outpass_today_logs').data('url'),
